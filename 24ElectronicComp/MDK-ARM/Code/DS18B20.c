...
#define ResetDQ() HAL_GPIO_WritePin(ds18b20_dat_GPIO_Port, ds18b20_dat_Pin, GPIO_PIN_RESET)
#define SetDQ()  	HAL_GPIO_WritePin(ds18b20_dat_GPIO_Port, ds18b20_dat_Pin, GPIO_PIN_SET)
#define GetDQ()  	HAL_GPIO_ReadPin(ds18b20_dat_GPIO_Port, ds18b20_dat_Pin) 
...
float ds18b20_read(void)
{
	...
	Temperature = (float)((float)TemperatureData * (float)0.0625); //分辨率为0.0625度
