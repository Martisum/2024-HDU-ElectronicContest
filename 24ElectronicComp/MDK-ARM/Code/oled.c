...
unsigned char GRAM[1024];   //缓存显存数组
/***************************************************
    I2C总线传出数据函数：
...
//-------------------------------------------------------------------------------------------------------------------
// 函数简介     OLED 点亮指定位置的一个点函数
// 参数说明     x               x 轴坐标设置 0-127
// 参数说明     y               y 轴坐标设置 0-63
// 返回参数     void
// 使用示例     OLED_DrawPoint(unsigned char x,unsigned char y);
// 备注信息
//-------------------------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------------------------
// 函数简介     OLED 熄灭指定位置的一个点函数
// 参数说明     x               x 轴坐标设置 0-127
// 参数说明     y               y 轴坐标设置 0-63
// 返回参数     void
// 使用示例     OLED_ClearPoint(unsigned char x,unsigned char y);
// 备注信息
//-------------------------------------------------------------------------------------------------------------------
